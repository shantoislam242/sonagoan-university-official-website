...
export const JOURNAL_ISSUES: JournalIssue[] = [
  ...
  },
  {
    ...
    technicalNote: { title: 'Technical Note', pdf: '#' },
    articles: [
      A('Numerical Simulation of NACA 4412 Airfoil to Analyse its Performance Characteristics M15 and M20'),
      A('A Comparison of Compressive Strength of Concrete by Using Different Brands of Portland Composite Cement for Grade M15 and M20'),
      A('Production of Sustainable Alternative Building Block'),
      A('Analyzing the Apparel Buying Behavior of Middle Age Men'),
      A('Threats of RMG Sector in Bangladesh and Possible Way Outs'),
      A('Corporate Governance Practices in Bangladesh: An Overview of Pharmaceutical, Chemical and Ceramic Industry'),
      A('An Investigation of Microclimatic Influence of Greening Roofs, Walls, and Terraces in Urban Dwellings: A Case of Uttara, Dhaka'),
      A('Automatic Voltage Regulator Control Simulation Analysis using Differential Evolution Algorithm'),
      A('Survival Scenario of the Street Children in Bangladesh'),
    ],
  },
  {
    slug: 'volume-3',
    ...
    technicalNote: { title: 'Technical Note', pdf: '#' },
    articles: [
      A('Shaping Festival Financing and Expenditure: A Fair Assessment of Bangladeshi Earnings Capable Residents'),
      A('Mixed Convection in a Ventilated Concentric Horizontal Cylindrical Annulus for Aiding and Opposing Buoyancy Forces'),
      A('Study and Analysis of Production Management using Renewable Energy for Sustainable Development'),
      A('Natural Convection in a Horizontal Cylindrical Annulus with Equally Spaced Radially Divergent Longitudinal Solid Fins: Part I'),
      A('From Morality to Legal Right: A Comprehensive Analysis on Parent’s Alimony'),
      A('Evaluation of the Effect of End Conditions on the Load Carrying Capacity of Long Column'),
      A('A Detail Study of Inspiration to Fashion Design in the Context of Ready Made Garment (RMG) Industry in Bangladesh'),
      A('Analysis of Extracted Bio-Fuel from Plastic based Solid Medical Waste through Pyrolysis'),
      A('Study of Seam Performance of Jute Bag in Plain and Twill Fabric'),
    ],
  },
  { slug: 'volume-2-number-2', volume: '2', issue: '2', period: 'December 2017', fullPdf: '#' },
  { slug: 'volume-2-number-1', volume: '2', issue: '1', period: 'June 2017', fullPdf: '#', size: '92.27 MB' },
  {
