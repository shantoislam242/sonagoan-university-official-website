...
export const JOURNAL_ISSUES: JournalIssue[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      A('Comparative Performance Evaluation of Classical Machine Learning and Quantum SVM for Heart Disease Prediction using a Quantum-Featured Dataset', '/assets/journal/v5i1/journal3.pdf'),
      A('Development of an Automated Railway Gate Control System for Enhanced Safety in Bangladesh', '/assets/journal/v5i1/journal4.pdf'),
      A('Environmental and Social Impacts of Artificial Intelligence and Digital Transformation on Industrial Management in Bangladesh', '/assets/journal/v5i1/journal5.pdf'),
      A('Impact of Human Resource Outsourcing Activities on Employee’s Performance of State-owned Commercial Banks in Bangladesh', '/assets/journal/v5i1/journal6.pdf'),
      A('International Labor Migration and Economic Development in Bangladesh: Evidence from an ARDL Analysis', '/assets/journal/v5i1/journal7.pdf'),
      A('Numerical Investigation of Fourth-Order Boundary Value Problems Using the Finite Difference Method', '/assets/journal/v5i1/journal8.pdf'),
      A('Perishable Production Inventory Model for Exponential Demand Rate with Constant Production Rate and offering Discount during Production Run', '/assets/journal/v5i1/journal9.pdf'),
      A('Redefining the Paradigm: How ChatGPT and Generative AI Are Transforming Scientific Publishing and Knowledge Dissemination', '/assets/journal/v5i1/journal10.pdf'),
      A('Socio-Demographical Causes behind Increasing Dependency on Caesarean Delivery: A Case Study on Literate Working Women Living in Dhaka City', '/assets/journal/v5i1/journal11.pdf'),
    ],
  },
  {
    slug: 'volume-4',
