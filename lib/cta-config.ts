...
export const cta = {
  ...
  // Higher % shifts the image content upward in the viewport (more
  // of the original image's middle/lower portion fills the frame,
  // the top fence/building strip moves off-screen).
