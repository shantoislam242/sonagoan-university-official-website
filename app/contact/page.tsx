...
export default function ContactPage() {
  return (
    <>
      ...
      {/* rts contact info */}
      <section className="rts-contact-info rts-section-padding">
        <div className="container">
          <div className="row">
            <div className="rts-section rt-center mb--40">
              <h2 className="rts__section--title text-capitalize">General Contact Information</h2>
            </div>
          </div>
            ...
            <div className="row justify-content-md-start  justify-content-sm-center g-5">
              <div className="col-lg-4 col-md-6 col-sm-10">
                <div className="single-contact">
                  <div className="single-contact__single">
                    <div className="icon">
                ...
                <div className="single-contact">
                  <div className="single-contact__single">
                    ...
                    <div className="method">
                      <a href="callto:+442041542541" className="phone">+44 20 4154 2541</a>
                      <a href="callto:+442041542542" className="phone">+44 20 4154 2542</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="rts-campus-contact pb--120">
        <div className="container">
          <div className="row">
            <div className="rts-seciton rt-center mb--40">
              <h2 className="rts__section--title text-capitalize">Other Campus Contacts</h2>
            </div>
          </div>
          <div className="contact-method">
            <div className="row justify-content-md-start justify-content-sm-center g-5">
              <div className="col-lg-4 col-md-6 col-sm-10">
                <div className="contact-method__single">
                  <div className="contact-img-bg">
                    <img src="/assets/images/contact/01.jpg" alt="" />
                  </div>
                  <div className="contact-text">
                    <h3 className="contact-title">London</h3>
              ...
              <div className="col-lg-4 col-md-6 col-sm-10">
                <div className="contact-method__single">
                  ...
                  <div className="contact-text">
                    <h3 className="contact-title">New York</h3>
              ...
              <div className="col-lg-4 col-md-6 col-sm-10">
                <div className="contact-method__single">
                  ...
                  <div className="contact-text">
                    <h3 className="contact-title">Boston</h3>
          ...
          <div className="contact-map mt--30">
            <iframe className="contact-map" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14602.288851207937!2d90.47855065!3d23.798243149999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1663151706353!5m2!1sen!2sbd" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
