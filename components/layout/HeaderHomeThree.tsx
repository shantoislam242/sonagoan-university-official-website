 ...
 * Includes social icons on the left (v__3 layout). jQuery plugins attached by main.js +
 * VendorPluginInitializer.
 */
export default function HeaderHomeThree() {
  return (
    <header className="header header__sticky v__3">
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="header__wrapper">
              ...
              <div className="header__center__content">
                {/* menu left side */}
                          ...
                          <ul className="submenu sub__style">
                            ...
                            <li className="has-child has-arrow">
                              ...
                              <ul className="sub__style">
                                ...
                                <li className="has-child"><Link href="/faculty-details">Faculty Staff
                                    details</Link></li>
                              </ul>
                            </li>
                            <li><Link href="/index-three">Research</Link></li>
                          </ul>
                        </li>
                        <li className="navigation__menu--item has-child has-arrow">
                      ...
                      <ul>
                        ...
                        <li className="navigation__menu--item has-child has-arrow">
                          ...
                          <ul className="submenu sub__style">
                            ...
                            <li><Link href="/blog-details">Blog Detaila</Link></li>
                          </ul>
                        </li>
              ...
              <div className="header__right">
                <div className="header__right--item">
                  ...
                  <div id="menu-btn" className="menu__trigger">
                    <img src="/assets/images/icon/menu__bar-3.svg" alt="bar" />
                  </div>
                </div>
              </div>
            </div>
